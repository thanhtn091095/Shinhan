...
public class DownloadFileURL {
	...
	public static File DownloadFileFromURL(String url) {
	 ...
	 public static String DownloadFile1(String fileURL, String saveDir, String mimeType) throws IOException {
		 ...
		 try {
		        ...
		        if (responseCode == HttpURLConnection.HTTP_OK && httpConn.getContentLength() > 0) {
		            ...
		            String extension = printExtension(mimeType);
		            
		            String saveFilePath = saveDir + File.separator + fileName + extension;
	 	...
	 	public static String printExtension(String mimeType)
		{
	 		String extension = "";
			try{
	    		...
	    		System.out.println("hpt.has.shinhan.base64.DownloadFileURL.printExtension.Error: " + e);
	    		extension = "";
	    	}
			return extension;
		}
